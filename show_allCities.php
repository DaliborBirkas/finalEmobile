...
<body>
    ...
    <div class="container">
        <h3 class="text-center m-1">Pregled svih gradova</h3>
        <?php
                ...
                <table class="table">
                    ...
                    if ($query->rowCount() > 0) : ?>
                        <?php foreach ($results as $result) { ?>
                            <tr>
                                <td><?php echo $result->id_city ?></td>
                                <td><?php echo $result->city_name ?></td>
                                <td><?php echo $result->city_postcode ?></td>
                                <!--                        <td>--><?php //echo $result->balance 
                                                                    ?>
                                <!--</td>-->
                                <td>
                                    <a href="deleteCity.php?id_city=<?php echo $result->id_city ?>" class="btn btn-danger me-3">Obriši</a>
